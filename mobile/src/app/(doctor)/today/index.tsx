      ...
      case 'CONFIRMED':
        return (
          <TouchableOpacity 
            ...
            onPress={() => {
              // Cập nhật trạng thái sang CHECKING_IN hoặc EXAMINING
      ...
      case 'PENDING':
        return (
          <TouchableOpacity style={[styles.actionBtn, styles.confirmBtn]}>
            <Text style={[styles.actionText, styles.confirmText]}>Xác nhận</Text>
          </TouchableOpacity>
        );
      default:
        return null;
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.card}>
            ...
            <Text>Giờ: {item.appointment_datetime ? new Date(item.appointment_datetime).toLocaleTimeString('vi-VN') : 'N/A'}</Text>
